<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <li class="nav-item">
        <a class="nav-link" href="{{ url('/')}}" tabindex="-1" role="button" aria-disabled="true">Registrarse</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="{{ url('/')}}" tabindex="-1" role="button" aria-disabled="true">iniciar sesion</a>
      </li>
...
<li class="nav-item">
        <a class="nav-link" href="{{ url('/')}}" tabindex="-1" role="button" aria-disabled="true">  <button class="btn btn-outline-light" type="submit" ><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cart4" viewBox="0 0 16 16">
